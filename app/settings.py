...
DEFAULT_OUTPUT_IMAGE_1 = IMAGES_DIR / 'default_output_image_1_all.png' # all version
DEFAULT_OUTPUT_IMAGE_2 = IMAGES_DIR / 'default_output_image_1_message.png' # bbox version
