...
def main(CFG_DIR, OUTPUT_DIR, video_path, score_threshold): 
    ...
    if video_path is not None:
        ...
        detect_video(pedestrian_model, traffic_light_model, lane_model, video_path, OUTPUT_DIR, score_threshold, cfg['pedestrian']['iou_threshold'], cfg['pedestrian']['confidence_threshold'], cfg['pedestrian']['warning_distance'], device)

if __name__ == "__main__":
    CFG_DIR = '/home/yoojinoh/Others/PR/prometheus5_project_AIDrivingGuide/configs/model.yaml'
    OUTPUT_DIR = '/home/yoojinoh/Others/PR/prometheus5_project_AIDrivingGuide/app/videos/test_video4_outputs_message_only.mp4'
    video_path = '/home/yoojinoh/Others/PR/data/videos/test_video4.mp4'
    score_threshold = 0.25
    main(CFG_DIR, OUTPUT_DIR, video_path, score_threshold)   
